...
| 샘플 | 이전 F@2px | 현재 F@2px | 선 F@2px | 선 굵기 | p95 | 작은 디테일 | 패스 | 판정 |
|---|---:|---:|---:|---:|---:|---:|---:|---|
| shoe_1 | 0.384 | 0.894 | **0.998** | 0.93 | 1px | 100% | 890 | PASS |
| shoe_2 | 0.689 | 0.906 | **0.997** | 0.94 | 1px | 100% | 1,802 | PASS |
| shoe_3 | 0.730 | 0.966 | **0.998** | 0.93 | 1px | 100% | 2,728 | PASS |
| bag_1 | 0.465 | 0.898 | **0.999** | 1.02 | 1px | 100% | 406 | PASS |
| bag_2 | 0.319 | 0.945 | **0.945** | 1.82 | 3.4px | 99.7% | 3,583 | PASS |
| bag_3 | 0.756 | 0.999 | **0.999** | 1.04 | 1px | 100% | 1,636 | PASS |
| jewelry_1 | 0.744 | 0.991 | **0.991** | 0.96 | 1px | 100% | 235 | PASS |
| jewelry_2 | 0.879 | 0.994 | **0.994** | 0.83 | 1px | 100% | 542 | PASS |
| jewelry_3 | 0.645 | 0.864 | 0.867 | 0.76 | 15px | 100% | 467 | REVIEW |
| **평균** | **0.620** | **0.940** | **0.976** | | | | | 8/9 |

「선 F@2px」는 해프톤 질감 영역을 뺀 값입니다 — 그 자리는 점 대신 톤 면으로 그리는 것이
의도이므로, 전체 지표에 넣으면 "선이 빠졌다"로 집계돼 진짜 결함이 묻힙니다.
invalid geometry는 9종 모두 0입니다.
